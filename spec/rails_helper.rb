...
require File.expand_path('./support/stubbed_requests', __dir__)
require File.expand_path('./support/api_helper', __dir__)
...
RSpec.configure do |config|
  ...
  config.extend JsonRequestHelper, type: :request
